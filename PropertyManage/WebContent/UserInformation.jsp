...
<div class="box">
    <form class="style" action="ChangeUserInformation" method="post" onsubmit="return checkForm();">
    <table>
     <tr>
    <td><label>id</label></td>
    <td width="350px"><input id="1" type="text"  name="userid" value="${useid}"  readonly="true"></td>
    </tr>
    <tr>
    <td><label>账号</label></td>
    <td width="350px"><input id="1" type="text"  name="account" value="${useaccound}"  readonly="true"></td>
    </tr>
    <tr>
    <td><label>密码</label></td>
    <td width="350px"><input id="2" type="text" name="password" value="${usepassword}"></td>
    </tr>
    <tr>
    <td><label>电话号码</label></td>
    <td width="350px"><input id="3" type="text" name="phone" value="${usephone}"></td>
    </tr>
    <tr>
    <td><label>姓名</label></td>
    <td width="350px"><input id="4" type="text" name="username" value="${usename}"></td>
    </tr>
    </table>

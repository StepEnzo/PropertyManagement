...
<div class="box">
    <form class="style" action="AddAdmin" method="post" onsubmit="return checkForm();">
    <table>
    <tr>
    <td><label>账号</label></td>
    <td width="350px"><input id="1" type="text"  name="account" placeholder="请输入账号"></td>
    </tr>
    <tr>
    ...
    <td width="350px"><input id="4" type="text" name="name" placeholder="请输入姓名"></td>
    </tr>
    </table>

...
<div class="box">
    <form class="style" action="DamageServlet?tag=edit" method="post" onsubmit="return checkForm();">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td width="350px"><input id="1" type="text" name="pid" placeholder="请输入资产编号"></td>
            </tr>
            <tr>
            <tr>
                <td><label>损坏程度</label></td>
                <td width="350px"><input id="2" type="text" name="level" placeholder="请输入损坏程度"></td>
            </tr>
            <tr>
                <td><label>处理方法</label></td>
                <td width="350px"><input id="3" type="text" name="solution" placeholder="请输入处理方法"></td>
            </tr>
        </table>
